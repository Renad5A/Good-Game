...
class ChatPage extends StatelessWidget {
  ...
  List<_ChatThread> get threads => [
        _ChatThread(
          name: "Khalid",
          lastMessage: "Are you joining today?",
          time: "3:45 PM",
          unread: 2,
        ),
        _ChatThread(
          name: "Faisal",
          lastMessage: "Location is updated ✅",
          time: "11:20 AM",
          unread: 0,
        ),
        _ChatThread(
          name: "Evening Running Group",
  ...
  Widget build(BuildContext context) {
    ...
    if (args is Map && args["chatType"] == "group") {
      final String groupName = args["groupName"] ?? "Group Chat";

      Future.microtask(() {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => ChatDetailsPage(threadName: groupName),
          ),
        );
      });
    }
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: Text(
            thread.name.isNotEmpty ? thread.name[0].toUpperCase() : "C",
          ),
        ),
        title: Text(
          thread.name,
